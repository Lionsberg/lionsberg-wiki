...
While the vast majority of the [[Word Tools]] used in the [[LIONSBERG System]] may be adequately translated by AI or other tools, special attention should be paid to carefully establish interoperability among all [[Word Tools]] in [[The LIØNSBERG Lexicon|the Lexicon]] across all native languages. 

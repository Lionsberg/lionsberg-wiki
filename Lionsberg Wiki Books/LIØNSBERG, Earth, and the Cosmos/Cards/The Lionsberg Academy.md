...
- **The Cell** — the irreducible unit. Three to sixteen sovereign Beings forming themselves through living relationship, daily practice, and shared Quest. Every Circle that runs the [[The Seven Moves|Seven Moves]] is already an Academy Cell. The Academy is not added to the Circle; the Academy IS the formation-dimension of the Circle.
- **The Guild** — the federation of practitioners in a craft. Healers across many Cells. Builders. Storytellers. Warriors. Farmers. Coders. Every Path of Mastery has its Guild, in which apprentices, journey-folk, and masters move together.
- **The Council** — the standing eldership that holds wisdom-decisions for the Academy at any scale. Bioregional Councils. Guild Councils. The Council of Councils for the Grid-scale work.
- **The Roving Temple Dojo** — the mobile physical expression of an Academy Cell. Temple + monastery + dojo + healing center + initiation portal. The first construction-grade prototype of an Academy site.
- **The Universe(ity)** — the planetary federation of all Cells. Not a building. Not a brand. The lived totality of the formation-work happening everywhere.
...
- **No batched-cohort end-of-program.** Formation does not end at week 12. The 3-Year Cycle is the floor. Lifelong learning is the ceiling that never closes.

The Academy stands ready to receive what survives of the Old World's learning infrastructure. Khan Academy, MIT OpenCourseWare, Duolingo, the surviving universities, the surviving libraries — these become **the lower rung**, the externally-curated knowledge stack the Academy uses as one of its inputs. They are honored for what they preserved. They are not the Academy itself. The Academy is woven from formed Beings in living relationship; external content alone cannot make it.

The Academy is also **bioregional before it is planetary**. Children are formed in living relationship with their land, watershed, ecosystem, and people. Place is the first teacher. A child raised in the Academy of one bioregion will know that bioregion intimately — its plants, its weather, its waters, its sacred sites, its history — and will carry the Pattern in a way that is unmistakably **here**.
...
Lives canonically in [[The LIØNSBERG Pattern Language]] within Pillar IV (Sacred Learning and Mastery), and informs [[The LIØNSBERG Playbook]] at every operational stage from Threshold to Mastery.

...
status: captured
fold_target: IV
themes: [playbook, currencies, allocation, attention, time, energy, sacrifice, foundational]
source: Phase 2.1 audit of The Wisdom of the Way
captured: 2026-05-19
---
...
Every Pilgrim, in the [[The Voluntary Leap Forward|Voluntary Leap Forward]], sacrifices something. The career that no longer fits the Pattern. The relationships that demand the Pilgrim shrink. The comfort that prevents growth. The identity that the awakening has outgrown. None of these sacrifices is wasted; each becomes the seed of what comes next. But each is real, and the Pilgrim who imagines they can move into the New without any sacrifice has misunderstood the architecture.

At the deepest layer, Sacrifice includes the willingness to lay down life itself — what [[The Warrior's Vow|the Warrior's Vow]] formalizes. Most Pilgrims will not be asked to make this ultimate Sacrifice; but every Pilgrim must reach the point of **willingness**. The willingness, even un-tested, transforms how the Pilgrim moves through the world.

**The discipline of the Four Currencies.**

For each currency, the Pilgrim asks the same question: **am I spending this in alignment with [[LIONSBERG Wiki Books/LIØNSBERG, Earth, and the Cosmos/Cards/ØNE|the ONE]] and [[The Goal]]?** Where the alignment is present, the spending is right. Where the alignment is absent, the spending is to be reconsidered.

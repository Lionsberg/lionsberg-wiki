...
status: captured
fold_target: II
themes: [pattern-language, pillar-i, metaphysics, aurobindo, foundational]
...
The metaphysical mechanism beneath the Sacred Ascent.
...
- The Vedic tradition called it the cycle of manifestation and return.
- The Kabbalah called it _Tzimtzum_ (the contraction) followed by _Tikkun_ (the repair).
- Christianity called it the Fall (descent) and the Restoration (ascent).
- Process philosophy called it the concrescence of actual occasions.
- LIØNSBERG calls it the [[The Sacred Spiral — Not a Circle|Sacred Spiral]] — the eternal upward turn of all things rising.

Three implications:

- **Evolution is not random.** It is the directed return of Spirit through Matter. The "anti-entropic force" that physics struggles to explain is the Spirit-impulse that drives the Cosmos toward greater complexity, consciousness, and coherence. Evolution is the Sacred Ascent rendered in biological time.
...
Lives canonically in [[The LIØNSBERG Pattern Language]] (Volume II) as foundational metaphysics within Pillar I (Sacred Ontology and Metaphysics), and reverberates through [[The Sacred Ascent]] (Volume VII) as the cosmological architecture of the eternal upward spiral.

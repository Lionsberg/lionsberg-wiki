...
status: captured
fold_target: IV
themes: [playbook, healer-codex, named-practice, breath, vagal-tone, foundational]
...
- **Exhale fully.** Empty the lungs completely. This is the preparation move; it sets the diaphragm for the inhale that follows.
- **Inhale through the nose for 4 counts.** Steady. Deep. The breath fills the lower lungs first, then the middle, then the upper. Pace: roughly one count per second, but the count itself matters more than the second — the relative ratio is what produces the effect.
- **Hold the breath for 7 counts.** Closed mouth. Closed lower throat. Pressure builds slightly. The CO2 begins to rise in the bloodstream; this is intentional and signals the body in specific ways.
- **Exhale through the mouth for 8 counts.** Slowly. Audibly if needed (a soft _whoosh_ sound is part of the canonical form). The exhale is the longest phase; this is what triggers the maximum Vagal response.

That is one cycle. The standard practice is **four cycles** in sequence. Total time: roughly 2-3 minutes, depending on count pace.

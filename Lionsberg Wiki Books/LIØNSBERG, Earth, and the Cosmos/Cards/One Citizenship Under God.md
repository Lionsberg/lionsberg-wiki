...
- Then: bioregional citizenship — to the land that holds the Sovereign
- Then: community citizenship — to the gathered ones in the place
- Then: tribal / cultural / religious citizenship — to the lineage the Sovereign carries
...
What the Pattern adds is **architectural**. One Citizenship Under God is not only an interior conviction; it is a **political fact** in the New Civilization. The covenanted Sovereign has:
...
- An **identification** that travels with the Sovereign across borders, recognized by every other Sovereign under the same Covenant.
- A **community** — the Circle, the Hub, the Grid — that holds the Sovereign regardless of the nation-state's posture toward them.

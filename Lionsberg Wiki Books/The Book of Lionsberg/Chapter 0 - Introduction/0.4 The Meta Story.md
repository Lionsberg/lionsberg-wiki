...
The very systems we stood up to solve our most pressing threats in previous centuries are now creating an entirely new class of existential threats. These complex, interrelated crises threaten to grow exponentially as we accelerate technology, science, and industry along these same paths.  
...
In isolation, we all lack the total resources, relationships, and true transformational power needed to transform the deepest [[Root Cause|Root Causes]].  
...
Back to [[0.2 Book of LIØNSBERG Legal Page]]  

...
Yet the Reality is that only One is Absolutely True, and [[ØNE]] and [[All]] that flows from It will eternally be a Mystery that we can relate to but never fully grasp.  
...
There is only [[ØNE]] thing that you should cling to so tightly. There is only [[ØNE]] thing that remains the same inside and outside the [[Boundary]]. 

Truth is a strange thing, in that we can always lay down our [[Current Best Understanding]], and trust that if it remains we will always rediscover it. Yet if we are not willing to lay it down and test it, we will never experience the possibility of knowing something [[Beyond]]. 

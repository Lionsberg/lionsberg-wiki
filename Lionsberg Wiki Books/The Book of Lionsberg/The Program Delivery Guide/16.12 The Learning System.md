...
## Five Levels of Lesson Capture

Learning flows through five channels — each operating at a different scale, each carrying a different quality of intelligence, each essential to the health of the Whole.

- **Zone to Zone** — Circles in the same geographic region share what they discover about local conditions — institutions, resources, obstacles, opportunities no plan anticipated. The soil is different here. The political landscape shifted. The community responded to this approach and rejected that one. Zone-level learning is the intelligence of place — the irreplaceable knowledge that only those who live and work in a particular landscape can generate.

- **Area to Area** — Circles pursuing similar Quests across different communities share what works and what does not. Food sovereignty in one bioregion. Governance reform in another. Education transformation in a third. Every community attempting the same work encounters different conditions — and the synthesis of their experiences produces understanding that no single community could reach alone. Area-level learning is the intelligence of domain — the accumulated wisdom of practitioners solving the same category of problem across every context the planet presents.

- **Partner to Partner** — Circle-to-Circle transmission. Practitioner knowledge flowing laterally, at the speed of trust, bypassing hierarchy entirely. Not filtered through management. Not summarized for executives. Not stripped of nuance to fit a reporting template. Raw, honest, practitioner-to-practitioner exchange — the kind of knowledge that only travels when one person who has done the work speaks directly to another person about to do it.

- **Supplier to Supplier** — Stewards of shared resources coordinate across the network. Delivery methods, standards, specifications, quality benchmarks — refined through the collective experience of every node in the supply network. What one supplier learns about material quality propagates to every supplier handling the same material. What one resource steward discovers about distribution logistics becomes available to every steward facing the same challenge.

- **Person to Person** — The irreducible foundation. One sovereign agent telling another what the work revealed today. Around a fire. Across a table. Through a message sent at midnight because the insight could not wait until morning. This is how the deepest knowledge has always traveled — hand to hand, voice to voice, presence to presence. No system can replace it. Every system must protect it.
...
**Second: The searchable commons.** A living library organized by keywords, domains, regions, Quest types — retrievable on demand by anyone in the network. Automatic notifications push relevant information to identified participants **before** they encounter the conditions that generated the lesson. The Circle about to begin water infrastructure work in a semi-arid region receives, without asking, the distilled experience of every Circle that has done similar work in similar conditions. The intelligence arrives ahead of the need. The commons anticipates.
...
Forward to [[16.13 Quality and Safety]]
Back to [[16.11 Tightly Coupled Learning and Action]]

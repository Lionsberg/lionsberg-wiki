...
The six quality strategies — First Run Studies, Standard Work, Error Proofing, the Zero-Defects commitment, systematic learning from every variance, and Managing the Commons — were addressed at the site level. They operate identically at every scale of the program, because the principle that generates them does not change with scale.

A bad system defeats a good person every time. You do not fix quality by exhorting people to try harder. You fix quality by designing systems in which the natural flow of work produces the right outcome — and in which deviation from the right outcome is immediately visible, immediately investigated, and immediately corrected.
...
Forward to [[16.14 Measuring and Managing Performance]]
Back to [[16.12 Production Planning and Control]]

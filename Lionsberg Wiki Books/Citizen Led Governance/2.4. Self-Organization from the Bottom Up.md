...
At the heart of the LIØNSBERG System and Approach is the belief that citizens, when empowered and given the right tools and structure, can self-organize and self-govern to address complex challenges. This bottom-up approach to governance relies on the following elements:

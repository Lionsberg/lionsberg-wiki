...
8.  Be a part of the United Front: The awakened generation can be a part of the united front, a coalition of like-minded individuals and organizations that are co-operating the LIØNSBERG System and working towards a common goal of addressing the Meta Crisis and co-creating a better future.
    
9.  Volunteer for and support organizations like LIØNSBERG that are working on the Meta Crisis, or any other crisis or social issue that aligns with their values.

...
1. Collect all similar tasks and functions into job descriptions
2. Create organization chart without names
3. Review activities and FTEs for one site
4. Time phase the FTEs
5. Refine the organization chart collaboratively
6. Budget each per job-function and multiply by volumizing
7. Add appropriate names and companies

...
1. Identify a value stream that would benefit from analysis
2. Map the existing supply chain and value stream
3. Analyze value stream map using program requirements
4. Model optimal value stream based on program requirements (demand)
5. Implement optimal value stream and monitor/improve

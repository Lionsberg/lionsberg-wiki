...
## Embodiment 
While we recognize that what is trying to emerge is universal in scope, we also recognize that we need a structure and place to act out the "Spirit" of it - for that reason we have established [[LIØNSBERG]] and the LIØNSBERG [[Provisional Structure]]. 
...
- Sample descriptive name(s): 
	...
	- LIØNSBERG | Meta Game
	- LIØNSBERG | Elevation Initiative 
	- et al. - expandable to a growing array of initiatives  
- Website - [LIØNSBERG Wiki](https://LIØNSBERG.wiki)  
- [[One Sentence]]  - Sums up the entire System / Platform / Community in one sentence  
- [[Welcome to LIØNSBERG]]  
- [[LIØNSBERG Intention]] - The Intention  
- [[LIØNSBERG Goal]] - The Aim
- [[Core Values]] - Briefly outlines the foundation in universal / core Values  
- [[LIØNSBERG Vision]] - Briefly paints a picture of the outcome  
- [[LIØNSBERG Mission]] - Briefly explains what we do to realize the vision / intention / Goal  
...
- [LIØNSBERG Wiki](https://www.LIØNSBERG.wiki) - Portal to hundreds pages of supporting content, details, and concepts  
...
- LIØNSBERG | [[Meta Game]] 
- LIØNSBERG | [[Elevation Initiative]] 
- LIØNSBERG | [[Meta Community]]  
- 
## Clear System and Methodology 
The LIØNSBERG | Meta Project is rooted in the balance of both [[Being]] in [[Community]], and [[Doing]] in an effective way through the [[LIØNSBERG System]]  

...
<section>
  ...
  <div class="cards">
    <a class="card" href="/The_Decision_Log.html"><h3>📜 The Decision Log</h3><p class="line">What was decided, when, and why. Read it before re-asking; question it forward, through the doors.</p></a>
    <a class="card" href="/LIØNSBERG_Issue_Tracker.html"><h3>🪨 The Issue Tracker</h3><p class="line">What blocks the work. When something stops you, log it — a named issue is half-solved.</p></a>
    <a class="card" href="/Request_For_Guidance.html"><h3>🧭 Request For Guidance</h3><p class="line">What is unclear. Ask before assuming — every good question improves the plans.</p></a>
    <a class="card" href="/Submittals.html"><h3>📬 Submittals</h3><p class="line">What awaits review and approval — proposals, tools, and improvements offered to the whole.</p></a>
  </div>

...
As we began to articulate the [[LIØNSBERG Integrated Delivery System]], our friends alerted us that tens of millions of dollars and many years had been invested into this system, and that it was available for our use and adaptation. 
...
There is only [[ØNE]] answer, and that is [[The Goal]]. 

How? 

Once we select the single highest overarching and uniting [[Meta Goal]], and articulate the [[Total Nested Holarchy of Goals]] it contains and orders within itself...  

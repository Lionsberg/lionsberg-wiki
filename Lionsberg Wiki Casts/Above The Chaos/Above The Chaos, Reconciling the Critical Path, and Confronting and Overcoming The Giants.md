...
- This can only be realized by a technological revolution involving **total Spaceship Earth**, using [[All]] the [[Resources]] and [[Know How]] as an **integrated regenerative system** (herein called the [[LIØNSBERG System]]), as in the design of any successful seagoing ship or biological organism. (Sometimes we use the metaphor of an [[Ark]] for [[LIONSBERG]]). 

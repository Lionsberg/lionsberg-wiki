...
## What Every Quest Produces

When a Circle completes a Quest — or even a meaningful phase of one — it generates four kinds of output:

- **Results** — the tangible outcomes; the garden planted, the well dug, the curriculum built, the family housed, the conflict resolved
- **Learnings** — what worked, what did not, what you would do differently, what surprised you; these are as valuable as the results themselves
- **Resources** — tools, templates, processes, contacts, knowledge that can be reused by other Circles facing similar challenges
- **Stories** — the living proof that transformation is possible; the narrative of real people doing real work and creating real change
...
- **Document your Quest** — a brief account of what you set out to do, what you did, what happened, and what you learned
- **Share your resources** — any tools, templates, guides, or contacts that others could use
- **Tell your story** — in your own voice, with honesty about both triumphs and failures
- **Tag and categorize** — so that others can find what you have contributed when they need it
...
- Circles learn from each other without having to make the same mistakes
- Guilds build shared standards of excellence across the network
- Communities coordinate Quests that cross boundaries
- The planetary movement tracks its progress toward milestones that matter

...
A core element of the [[LIØNSBERG System]] is [[Interoperability]] among a growing diversity of of expressions. This requires very careful focus on the underlying data models, so that they can be brought to light in many different cultures, in many different ways, for many different purposes. 

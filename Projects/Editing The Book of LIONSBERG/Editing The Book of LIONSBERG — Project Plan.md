...
- **Christopher Alexander's _A Pattern Language_** — the encoding of living architecture into transmissible form
...
_Sessions = sustained working blocks. Multiple steps can sometimes be combined. The page-by-page pass is the longest phase but the most parallelizable._
...
_The seed is alive. The tree is magnificent. It needs pruning — not to make it smaller, but to let the light reach every branch._

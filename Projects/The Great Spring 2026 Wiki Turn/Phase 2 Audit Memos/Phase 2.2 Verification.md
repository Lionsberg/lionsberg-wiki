...
| 3 | **Reinvestment as Free Choice** | "Members who do not need a distribution may reinvest it back into the entity to strengthen other needs. All reinvestments tracked and added to the Member's Investment Capital balance." | ⚠ **ADD** — operational pattern absent elsewhere in the ledger. [[The Book of LIØNSBERG]] target. |
...
| 5 | **Theory vs. Hypothesis** | "In strict scientific usage, a theory is the current best falsifiable description that has survived rigorous attempts to falsify it. Conventional usage conflates theory with hypothesis. Epistemic hygiene matters." | ⚠ **ADD** — [[The LIØNSBERG Lexicon]] entry on epistemic hygiene; cleanly distinguishable from Scientism vs. Science. Worth its own row. |

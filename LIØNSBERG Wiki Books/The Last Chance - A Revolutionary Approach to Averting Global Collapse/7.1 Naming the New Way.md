...
**J: *Now that we have established the need for a new system and approach in general, let's explore the LIØNSBERG System as a specific solution humanity can evaluate and implement if it is the Wise Right thing to do*.** 
...
Forward to [[7.2 Introduction to the LIØNSBERG System - A Comprehensive Solution]]  

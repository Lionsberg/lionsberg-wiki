...
1. **Donations**: Contribute to organizations like LIØNSBERG that are doing meaningful work. Even small, regular donations can make a difference.
...
1. **LIØNSBERG**: If you resonate with Jordan and LIØNSBERG, the best thing you can do is show your supporting by joining the movement. Once place to do that is [here](https://jordannicholas.org/join_the_movement).  

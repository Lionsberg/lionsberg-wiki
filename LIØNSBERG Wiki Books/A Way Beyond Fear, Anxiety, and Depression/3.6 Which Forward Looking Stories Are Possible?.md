...
If that is approximately [[True]], then essentially any [[Vision]] we can imagine is possible provided that it does not violate the boundaries or will of [[ØNE]] and [[All]]. 

It is not possible to indefinitely violate the boundaries and will of [[ØNE]] and [[All]], so eventually any Pattern of Action that does so would be thwarted. 

...
During the first two quarters of 2022, an initial group of co-creators was invited to begin implementation of the LIØNSBERG | Meta Project Program of Action. 
...
At its core, the entire Program of Action would need to be viewed as a single highest order [[System]], that integrated and aligned all other systems, resources, and energy into a functional unity capable of delivering the [[Total Nested Holarchy of Goals]]. 
...
Said more simply, the [[What]] of the Program was to develop the functional unity required to accomplish the [[Meta Goal]], which contains within itself and orders the [[Total Nested Holarchy of Goals]]. 
...
So we began working towards a set of [[LIØNSBERG Plans and Specifications]] that would begin to articulate, through pictures, diagrams, and words, how the [[New Era]] / [[New Community]] / [[New System]] / [[New World]] we were working together to [[Realize]] could function and be. 
...
For more detail on the [[How]], please see the [[LIØNSBERG Integrated Delivery Guide]], which goes into more detail on how to construct an Integrated System that produces [[Throughput]] of a [[Goal]].  

...
[[Left Off Here]] [[TKTK]] Fold into [[The LIØNSBERG Handbook]]  
...
The total concept and design of [[The Prototype]] will be articulated in a set of [[LIØNSBERG Plans and Specifications]]. The Plans and Specifications shall outline not only the functioning of the System and Prototype, but also the way in which it will be instantiated locally, and the way in which all instantiations can interoperate for the good of [[All]]. 

The Plans and Specifications, this Program Delivery Guide, the [[Meta Project Program Statement]], and the [[The Book of LIØNSBERG]] manuscript will be formatted and made available digitally in as many languages as possible relatively simultaneously around the globe. **_This is critical so that the pattern language can be activated in unison by IPD Teams around the world, around interconnected local and regional nodes, so that the pattern of transformation / global movement towards the Goal cannot be interrupted by any attack_**.
...
#### The Data Model
Both the need for interoperability, and the need for continuity across subsequent transformations of people and technology, demands that a [[Data Model]] be designed and implemented that is capable of helping the [[Federation]] accomplish these elements of the [[Total Nested Holarchy of Goals]]. 

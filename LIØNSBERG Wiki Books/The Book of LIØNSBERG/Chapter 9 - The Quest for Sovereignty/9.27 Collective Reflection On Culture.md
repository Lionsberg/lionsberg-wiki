...
The mindset is that if problematic [[Patterns of Action]] are manifesting, it is because there is something in the [[Total Nested Hierarchy of Conditions]] we are [[Co-Creating]] that is allowing that to emerge from the field of [[Potential]]. 

The tribe then takes collective responsibility for transforming the underlying [[Conditions]], so that the [[Reality]] that they desire manifests. 

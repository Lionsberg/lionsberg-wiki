...
Because we cannot select for only one sub goal, we are forced to construct a properly ordered [[Total Nested Holarchy of Goals]], so that we can have loving relationships, amazing sex and great food while elevating and transforming our lives and our world in service to [[ØNE]] and [[All]]. 

This requires us to integrate a total [[Personality]], properly functioning in pursuit of a properly ordered [[Total Nested Holarchy of Goals]], unified by the [[Meta Goal]]. 

A fully enlightened, conscious, integrated personality is one that has [[Properly Ordered]] itself, harmonized itself, and brought all its constituent parts into right relationship, and then properly harmonized this new [[Higher Order Functional Unity]] into [[Right Relationship]] and [[Higher Order Functional Unity]] with nature, society, and the [[ØNE]] from which [[All]] things flow.

Likewise, as we move up the [[Total Nested Holarchy of Abstraction]], a fully enlightened, conscious, integrated [[Society]] is one that has properly ordered itself, harmonized itself, and brought all its constituent parts into [[Right Relationship]], and then properly harmonized this new functional unity into right relationship and functional unity with nature and the [[ØNE]] from which society and nature flow.

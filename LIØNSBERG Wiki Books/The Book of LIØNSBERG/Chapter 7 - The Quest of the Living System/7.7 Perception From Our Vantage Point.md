...
We must zoom in to see things far smaller than we can see, we must zoom out to see things far larger than we can see, we must exit spacetime to perceive things in times and places that are not here and now, so that we can understand how to be and do how [[ØNE]] would be and do [[Here]] and [[Now]]. 

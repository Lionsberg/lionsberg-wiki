...
In 1956, five former students quit their jobs and started the first cooperative — ULGOR — manufacturing paraffin heaters. Arizmendi himself took no position in any cooperative. He said: _"Organize a group to do something — elect two coordinators, and I'll be back to check on you."_

Three years later, in 1959, the founders discovered that existing financial mechanisms were not suited to the new paradigm. They founded their own cooperative bank ([[Laboral Kutxa|Caja Laboral Popular]]) and their own private social security system ([[Lagun Aro]]).
...
5. **Tightly couple learning with action** — [[Tightly Coupled Learning and Action|continuous improvement]]
...
| The Single Lean Enterprise | The federation of [[Cell|Cells]] |

...
AND — crucially — this does not stop at the Circle. Circles naturally reach out and find one another. They begin cooperating on larger challenges. Communities emerge — not designed from above, but grown organically from _within_. Communities discover other communities. Watersheds and bioregions emerge. A planetary federation emerges.
...
At every level, every member retains an **equal one-member, one-voice stake** in the governance of the Whole. This is the _omni_ in omnifederation — all, everywhere, at every scale, interconnected, with equal voice. All members of the [[New Civilization]] this brings forth end up with an equal stake in whatever Whole they can conceptualize, federate, and co-create.  
...
1. A **[[Domains of Responsibility and Authority|Domain of Responsibility and Authority]]** — the living space
2. A **[[Selectively Permeable Membrane]]** — the boundary protecting sovereignty while allowing life to flow
3. A **[[Field of Agreements]]** — the shared governance freely consented to by all members
4. A **[[Commons]]** — the shared resources, nurtured by the voluntary contributions of those who sit at that table
...
- **Planetary**: Collaborative transformation of a world towards Heaven here and now  
- **Beyond**: The [[Meta Community]] — the total set of all properly functioning, coordinated, and rightly related sovereigns helping one another rise towards [[The Goal]] across communities, dimensions, and worlds.  
...
- Capital earns a fair but limited return — in Mondragon, maximum ~7%, non-equity, _as voted quarterly by stakeholders_. Capital is rented, not given sovereignty. It does not govern, it is governed. 
- Pay ratios are compressed — in Mondragon, approximately 1:7 from lowest to highest. Compare to the United States at approximately 1:330.
- Profit is distributed to those who create it — in Mondragon: 10% minimum to community/education, 30% to worker profit sharing, 60% to reserves and reinvestment.
- Worker = Member = Owner. There is no separation between those who do the work and those who govern and benefit from the enterprise.
- The internal bank ([[Laboral Kutxa]]) and private social security system ([[Lagun Aro]]) provide **financial sovereignty** — the system finances its own growth without dependence on external capital markets.
...
- **[[LIØNSBERG Units of Value]] (LUV)**: A time-energy currency of goodwill that circulates at high velocity within the system. Each unit of Meaningful Work performed multiplied by its [[Value Factor]] = units of value. Value is measured in voluntary contribution and capacity, not scarcity or fiat.
- **[[Voluntary Tithing]]**: Each sovereign freely contributes to the [[Commons]] they share — flowing inward to the center of the largest table they are a part of. There is no central organization to tithe to. No imposed percentage. Only federation and fields of agreement. Tithing is an invitation to resource shared commons that build abundance and access to resources no sovereign could access alone.  
- **[[Commons|Fractal Commonsing]]**: Each time sovereigns associate, a commons naturally emerges. The faster value flows into and circulates within these commons, the faster All rise together. Value leaving the system (exchanged for fiat currency) is energy dissipating into and reinforcing the extractive patterns of the Old World.  
- **Economic Sovereignty**: The system is designed to progressively reduce dependency on the Old World economy while building internal capacity to meet all needs. When enough of humanity remembers that all of its debts are owed internally and systematically fraudulent in their inception, the greatest celebration and jubilee in millennia will commence, and all will be sovereign and free. 
...
Arizmendi understood this deeply. He arrived in Mondragon in 1941, in a town of 7,000 dominated by a few rich industrialists. He spent **10 years** traveling, speaking, giving conferences. People agreed with the ideas. No one changed. He realized: _you cannot transform the Old. You must create the New. And to create the New, you must first form the people who will co-create and become it._
...
- Active, student-centered, project-based, group-based learning
- Students spend 1/3 of credits in live co-operatives
- Junior cooperatives for students — learn by starting actual enterprises
- Lifelong learning by teaching and coaching one another
- Coaches guide; they do not lecture or control  
...
- **Time Zero**: Onboarding
- **Year One**: Initial formation
- **Year Two**: Deepening
- **Year Three**: Integration
- Then ongoing maintenance and lifelong learning
...
- **The Universe(ity)** — a shared place where knowledge is cultivated  
- **Dojos** — places of practice and transformation  
- **Mutual formation** — teaching and coaching one another within Circles
...
AA Step 12: _"Having had a spiritual awakening as the result of these steps, we carry this message to others."_ Recovery requires transmission. You cannot complete your own healing without helping others begin theirs.

The early church: _"Go and make disciples."_ The message is inseparable from its transmission. The kerygma (core message) was short enough to transmit orally in minutes, deep enough to sustain a lifetime.
...
- **Economic sovereignty** at every level prevents financial capture. Self-supporting. No external dependencies.
- **Purpose is structurally sovereign** — The Goal is embedded in the governance architecture, not dependent on the good intentions of any current leadership.
- **Freedom to leave** at every level. No coercion. No penalties for departure. The system is held together by [[Love]], [[Wisdom]], and [[Influence]] — never by force.
...
- **Time-energy tracking** — Each Circle tracks the time and creative energy its members invest in [[Meaningful Work]]. This is the basis for [[LIØNSBERG Units of Value]] (LUV) — currency rooted in **proof of meaningful work** actually advancing The Goal.
...
- **Annually**: Strategic review. Is the system producing throughput of The Goal? Are we on track with the system wide master plan? What systemic adjustments are needed?
- **Planetarily**: The broader arc. Are we steadily progressing toward [[Heaven On Earth]]? What has changed? What must change? What should we do next to progress towards The Goal? 

...
- Wendy's Feedback 
    ...
    - Learnings from Volunteer organizing
        ...
        - What is needed - is people willing to LISTEN TO NEEDS... and ELEVATE ØNE ANOTHER. 
...
The idea of separating Meta Project from LIØNSBERG has a fatal flaw...  
- Because we need to be able to make decisions, write checks, etc. 

Closing Thoughts - Wendy  

- Need more detail on how I see the relationship of Meta Project and LIØNSBERG... 

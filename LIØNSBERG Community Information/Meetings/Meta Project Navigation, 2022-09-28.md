...
## NEEDS
- Clarity on what LIØNSBERG / Meta Project is... 
    - Can't do much until we know what LIØNSBERG and Meta Project is
...
- Michael 
    - Our experiment might be simply describing both the metaproject and our relationship(S) to it. What are the roles of LIØNSBERG, PlatetaryCare, OpenImpact, Massive Wiki, WINfinity, Catalist, FutureCapital, The UN, etc….? Not to mention other entities that unkown to us, but contributing already.
...
- Forrist
    ...
    - Going into a LIØNSBERG YouTube channel... 
...
- False start feeling... what is working alone... what is working together... stems from lack of definition... between... how our individual parts and separate efforst and those of people not in the room fit into the movement... and the difference between this movement and LIØNSBERG... 
...
- Forrist - +1 Pete - strong agree. and then this needs to address who has standing, what does it mean to be a member of ? LIØNSBERG, MetaProject something else?

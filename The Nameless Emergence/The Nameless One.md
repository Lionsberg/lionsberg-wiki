...
### At Circle Level
- Hosts a martial arts circle (3-12 practitioners)
- Participates as member, not director
- Tests circle protocols in real conditions
- Documents what works for others to replicate

### At Community Level
- Convenes [[The Sandpoint 300|North Idaho prototype]] (first 300 in community of ~10,000)
- Helps form circles and guilds
...
The validity of this unfolding will be proven or disproven by results:

**If [[the nameless emergence]] succeeds** and we co-create [[Heaven On Earth]]... 

**Then the origin story becomes irrelevant** - what matters is that it worked.
...
- [[The LIONSBERG Quick Start Guide]] - Universal entry point for all instances

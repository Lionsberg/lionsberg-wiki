...
Knowing the [[Way]] and walking it are different things, and Practice is the difference. The test is pragmatic: choose a worthy [[Aim]], and engage in a Practice that advances you toward it *measurably* — for a practice that cannot be felt or seen to move anything is a comfort, not a practice. What is practiced, strengthens; what is repeatedly done becomes what one is ([[Attunement]]: what is repeatedly attuned to, we become).

Its liberties and its disciplines:

**You are free to practice in your own Way.** The [[New World]] holds no compulsory forms learned on pain of hell; each Sovereign seeks and shapes the practices that genuinely transform them ([[Sovereignty]]). Freedom of form, though, is not freedom from form — no one is transformed by practices they do not do.

**Practice begins in [[Silence]] and extends into noise.** Focus is first learned where conditions are kind, then deliberately retained where they are not — the practice is not complete until it survives contact with the world ([[Focused Attention As Discipline]]).
...
In the fullest sense, the entire [[LIØNSBERG System]] is a Practice: [[The Great Game]] is played, the [[Way]] is walked, and the [[New World]] is practiced into being, not believed into it.

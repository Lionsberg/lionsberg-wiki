...
They also must be integrated and cohered by a [[Total Nested Hierarchy of Values]], which must be unified by a single highest overarching and uniting [[Meta Value]]. In the [[LIONSBERG System]], this is the [[ØNE]]. 
...
Therefore the Foundation, Center, Purpose and Goal of the [[LIONSBERG System]] and the Universe it serves is [[ØNE]]. 

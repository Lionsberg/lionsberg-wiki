...
## The Heartbeat: Discern, Plan, Do, Check, Adjust

At the center of continuous improvement is a simple rhythm — **DPDCA**:

- **Discern** — Before acting, pause. Listen. What is the Spirit calling forth? What is the true need? What does wisdom say? Discernment keeps improvement aligned with [[The Goal]], not driven by mere reaction.
- **Plan** — Based on what you have discerned, set a clear intention. What will you do? How? By when? With whom? A plan is not a prison — it is a hypothesis about what might work.
- **Do** — Act. Execute the plan. Engage the work fully, knowing that action is the only teacher that never lies.
- **Check** — Observe what actually happened. Compare it to what you intended. Where did reality match the plan? Where did it diverge? What surprised you?
- **Adjust** — Based on what you learned, change what needs changing. Refine the approach. Carry the wisdom forward into the next cycle.
...
- **Every defect is a gift** — it reveals where the system can grow
- **Every failure is a teacher** — it carries information that success never could
- **Every person is empowered to improve what they see** — you do not need permission to make something better

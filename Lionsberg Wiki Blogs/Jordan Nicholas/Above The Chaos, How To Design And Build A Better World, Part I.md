...
We chose a combination of a mythical / imaginative name for the [[Meta Idea]] and called it [[LIØNSBERG]]. We then coupled Lionsberg with descriptive names for the various things it would need to accomplish, such as the Lionsberg | Meta Project and Lionsberg | Meta Game.  
...
We brought together lifetimes of work to co-create a provisional [[LIONSBERG Integrated Delivery System]] as part of the [[LIØNSBERG System]]. 

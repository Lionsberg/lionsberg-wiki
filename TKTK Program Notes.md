...
7. ✅ **THE BOOK / THE STORY / THE GREAT GAME**: Articulate a 200 to 350 page book  mirroring the LIONSBERG Experience that transmits [[The Golden Seed of LIONSBERG]] - 50k to 150k words  
	...
	2. ✅  Working Title: [[the nameless bookx]]  - perhaps merge with the above  
...
10. 🔄 **THE PLAYBOOK**
	1. Now that [[the nameless bookx]] is in minimum viable form, it seems that a wise right next step might be to articulate the following 
...
- At the Wise Right Time, drop [[The Seed]] into a one or two groups and see what happens via [[The Invitation]] which leads to [[The Threshold Experience]] of [[the nameless bookx]]...  

...
2. A [[The Kingdom of LIØNSBERG — Plans and Specifications]] hosted by Lionsberg that allows us to gather and distribute resources, and interface with existing authorities  
...
1. A simple [[Welcome to LIØNSBERG]]  
...
It should be noticed that this Integrated Delivery System has been purpose-built to Integrate with the [[The Kingdom of LIØNSBERG — Plans and Specifications]].
...
Now that we have individuals organizing and federating into functional groups, and a [[The Kingdom of LIØNSBERG — Plans and Specifications]] in place, we are in a position to begin Making and Keeping [[Commitments]], and allocating resources in accordance.

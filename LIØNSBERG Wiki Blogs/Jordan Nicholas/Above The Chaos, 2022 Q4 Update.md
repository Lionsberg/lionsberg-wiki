...
From a **LIØNSBERG** perspective, our concrete goals for Q4 are: 

1. Onboard onto the OneLIØNSBERG Platform and activate the minimum viable **communications and decision making** system that a small core team is committed to.  
...
From a **LIØNSBERG | Meta Project** perspective, we have been **invited to play** at multiple different levels, and are going to run a series of 'lite' experiments to asses potential across 4 levels of complexity / analysis:  
...
If successful, these various experiments will subsequently get "hooked up" to the core LIØNSBERG communications, resourcing, and mission control systems that can empower any individual, organization, community, or project to develop towards the fullness of its potential... 

Personally, what I need to succeed is the ability to **resource a small core team and shared infrastructure** to work with me full time in service of the network and the array of functional teams.  Ideally I would like to resource 12 to 24 months of runway through the LIØNSBERG 501(c)(3) non-profit to satisfy the public support test and secure the platform and infrastructure. 

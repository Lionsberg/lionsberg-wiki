...
We have forged essentially a complete synthesis of how we would go about building LIØNSBERG and the Meta Project...  
...
23. Articulated a [[LIØNSBERG Vision]] 
24. Articulated a sensory Vision in [[Best Possible Future]] 
25. Articulated a [[LIØNSBERG Intention]]  
26. Articulated a [[LIØNSBERG Mission]]  
...
30. Articulated a [[Provisional Community Agreements]]  
...
34. Articulated a [[Total Nested Holarchy of Goals]] 
35. Articulated one overarching and uniting [[Meta Goal]]  
36. Articulated a [[LIØNSBERG System]] description 
37. Articulated a [[Meta Project]] description 
38. Articulated a [[LIØNSBERG]] description  
39. Articulated a [[Meta Game]] description  
40. Articulated a Provisional LIØNSBERG Governance Guide  - Moved to [[The LIØNSBERG Handbook]]  
41. Articulated a Provisional [[LIØNSBERG Integrated Delivery Guide]]  
42. Arcticulated patterning on organizing and federating 
43. Articulated patterning on teams producing and shipping work to the LIØNSBERG platform, using submittal process to review, approve, and incorpoate in a structured way. 
44. Articulated PM Backbone
45. Published ~ 2/3 of the [[The Book of LIØNSBERG]]  (Draft in Progress)
...
51. Created the opening [[LIØNSBERG Academy]] page - which contains a link to a free lifelong program of learning content. 
52. Started the [[LIØNSBERG Rosetta Stone]] to link access from any language in the world, to English, to all LIØNSBERG content. 
53. Started [[The LIØNSBERG Lexicon|the Lexicon]] of [[Concepts And Ideas]]  
...
64. Created a distributed collective memory that does not require the internet or cloud to function - [[LIØNSBERG Wiki]]
65. Created a framework for beginning to lift up the poorest and most vulnerable on earth, which forces us in stride to curate together the solutions, tools, technologies, plans, and specifications for how to build or rebuild society. 
	...
	3. [[Above The Chaos, The LIØNSBERG Energy Net, Water Net, Info Net, and Security Net]]  
66. Began to outline various collapse / attack type scenarios, and building the LIØNSBERG Platform on the basis of - [[Act As If]] meta crisis / attack / collapse will occur. 
67. Outlined a potential plan for LIØNSBERG | Water - as an opening example of how we could structure the [[Above The Chaos, The LIØNSBERG Energy Net, Water Net, Info Net, and Security Net]]... 
68. Introduced various meeting techniques and technologies, such as: 
	1. Fishbowl  
	2. [[Retrospective]]  
69. Created a placeholder [[LIØNSBERG Process List]] for further development 
70. Created a minimum viable [[Resourcing Guide]] 
71. Created a minimum viable [[3.2 Crowdfunding Overview]]  
72. Developed a minimum viable conceptual [[Time Currency]] - [[LIØNSBERG Time Currency]] 
73. Dodged a bullet because of Pete's wisdom and elevated to a continuously improving [[LIØNSBERG Currency]] based on [[Energy and Commitment Based UBI]]  
74. Defined [[Energy and Commitment Based UBI]] 

Etc. Etc...  

Beyond that foundational work, we had 10 to 20 brilliant, wise, mature minds on recorded weekly calls for 6 months melding deeply on the total framework for the emerge of the LIØNSBERG | Meta Project.  
...
- Creation of [LIØNSBERG Wiki](https:www.LIØNSBERG.wiki) infrastructure
- The LIØNSBERG Wiki acts as a collective memory and dynamic knowledge repository 
- Creation of LIØNSBERG Wiki web page. 
...
- Learned the workflow to quickly archive collaborate notes into the collective memory on LIØNSBERG Wiki 
...
- LIØNSBERG needs to keep a broad vision across the universal picture... and zoom in to where something may need to be fixed so that it does not become a critical obstacle... 
- this demands some kind of PM backbone for LIØNSBERG and understanding of the approximate global / universal critical path... 
...
- there is the total nested holarchy of issues and goals - say 25 or so... 
    - Each with a fund
...
- differentiation between LIØNSBERG and Meta Project created a lack of clarity / vonfusion / opacity
...
- Possible Patreon like mechanism for LIØNSBERG... 
...
- Not only to help LIØNSBERG speak, but to help each group speak, and to speak in a way that it can be aggregated and amplified. 
...
- It is not actually possible to separate Meta Project from LIØNSBERG and the source idea of both - because they are flowing from one source and we need to be able to make decisions, write checks, organize structures, etc. 
- Two levels - governance of LIØNSBERG and any legal commons... 
...
- It will be likely that we will want to set up service layers of LIØNSBERG (via curated small groups) to serve these functions for both LIØNSBERG and the group of groups. 
...
- Set up PM Backbone for LIØNSBERG in service of meta project
    - RFI / RFG
    - Submittals
    - Idea Logs
    - Issue Logs
- Set up a Pain Button for LIØNSBERG in service of meta project 
- Set up a Suggestion Box for LIØNSBERG in service of meta project 
- Set up a Wisdom Council for LIØNSBERG in service of the meta project 
    - Sensing emergence 
    - Sensing flow 
    - Discernment 
    - Strategy 
...
- What does a LIØNSBERG Meta Corps / a la Peace Corps, or Americorps, look like to allow people to afford to work together and contribute to society - who other wise couldn't afford to 

...
## Welcome 
Welcome to the LIØNSBERG | Meta Project
...
The next step is to email your response and guidance to Jordan at J@LIØNSBERG.org. 
...
The next step is to email Jordan at [J@LIØNSBERG.org](mailto:J@LIØNSBERG.org) addressing the 5 questions on page 13-14, and to forward this to the people you think most need to hear about it.
...
Forging this higher order functional unity and a place where we can work together effectively towards the ØNE THING THAT UNITES US ALL will ensure that we are not struggling or sub-optimizing in isolation, and that we have up to date visibility at all times into how we are doing on our highest shared quest towards the goal. 
...
emailing Jordan at [J@LIØNSBERG.org](mailto:J@LIØNSBERG.org) addressing the following: 
...
The ØNE Meta Goal that contains within itself and orders all other goals is (something like): 

The total integrated wellbeing, development, and right relationships of all generations of life in all times and places.

## Project

The ØNE Meta Project that contains within itself and orders all other projects is (something like):
...
The LIØNSBERG | Meta Project was specifically conceptualized as a clean white gathering place where people of goodwill could come together beyond the religious, political, and national lines that usually divide us, to focus on the One Thing that unites us all. 
...
When we are all aboard ØNE Vessel of Life and Society, and only 25% to 30% of us believe we are headed in the right direction, it is time to awaken, arise, unite, grab the helm, and change the trajectory before it is too late. 
...
The purpose of the Meta Project is to create an identifiable, clean, sacred space where we can come together above the political, religious, national, and organizational lines that usually divide us to Help One Another progress towards the ØNE THING that unites us All. 

The LIØNSBERG Integrated Delivery System operates by integrating and transforming any program of action into a single higher order Goal Delivery System, while helping and empowering each sovereign element and sub-goal. 
...
The next step is to forward this to the people who need to see it, and email me @ [J@LIØNSBERG.org](mailto:J@LIØNSBERG.org). 

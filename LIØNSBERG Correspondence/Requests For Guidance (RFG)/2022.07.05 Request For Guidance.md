...
2. A [[Provisional Structure]] hosted by LIØNSBERG that allows us to gather and distribute resources, and interface with existing authorities  
...
3. We are working on the architecture for multiple billion dollar "funds of funds" that will work together intelligently to progressively apply resources to measurable progress made that advances the [[Critical Path]] towards the various goals included in the [[Total Nested Holarchy of Goals]]. 
...
The results of this effort can be found in the LIØNSBERG [[LIØNSBERG Integrated Delivery Guide]]. 
...
3. The Respositories (Catalist and LIØNSBERG Wiki)
4. The Visualizations (Map Weavers)
5. The [LIØNSBERG Wiki](http:LIØNSBERG.wiki) - if you haven't seen this out, and if you are comfortable with a [[Work In Progress]] where a lot of links aren't yet created, check it out. It is rapdily turning into an exceptionally rich and interlinked source of information, ideas, philosophy, and content. 
...
3. A way for community members to easily set up blogs that integrate with and can refer to other elements of the LIØNSBERG Wiki. See [[LIØNSBERG Wiki Blogs]].  
4. A way for community members to easily publish books / manuscripts. For a starting point, see the work we did with:  
	1. [[The Book of LIØNSBERG]] - 10% Work in Progress  
	2. The [[LIØNSBERG Integrated Delivery Guide]] - 50% to 70% Work in Progress  
...
General information on the patterns can be found in [[Organizations The LIØNSBERG Way]], and the way organizations can collaborate and align energy can be found in the [[LIØNSBERG Integrated Delivery Guide]]. 
...
That is a bit of how we feel with the LIØNSBERG | Meta Project. Internally it is slow, fast, painful, joyful hard work - we use the hashtag #bootstrappingishard. And amazing. 
...
If you would like to know more about how this works, visit the [[LIØNSBERG Integrated Delivery Guide]], and in particular the section on [[0.2 Minimum Viable Version]]. 
...
3. Lastly, please email me your feedback on this [[Requests For Guidance]] to J@LIØNSBERG.org to let us know what resources, relationships, or improvements you might be able to offer during this cycle. 
